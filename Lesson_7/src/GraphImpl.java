...
public class GraphImpl implements Graph {
    ...
    private Vertex bfs(String startVertexLabel, String finishVertexLabel) {
        Vertex vertex = find(startVertexLabel);
        if (vertex == null) {
            return null;
        }
        ...
        while (!stack.isEmpty()) {
            ...
            if (vertex == null) {
                vertex = stack.pop();
                if (vertex.getLabel().equals(finishVertexLabel) ) {
                    resetVertexStates();
                    return vertex;
                }
            } else {
    ...
    public String findShortestPath(String startLabel, String finishLabel) {
        ...
        while ( currentVertex != null) {
            queue.addFirst(currentVertex.getLabel());
